...
namespace ECE141 {
  ...
  enum class Keywords {
    ...
    auto_increment_kw, between_kw, backup_kw, boolean_kw, by_kw,
    ...
    primary_kw, query_kw, quit_kw, restore_kw,
  ...
  using TTList = std::initializer_list<TokenType>;
